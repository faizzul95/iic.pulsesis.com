...
<head>
    ...
    <link href="<?= base_url(); ?>/vendor/assets/css/pages/error/error-5.css" rel="stylesheet" type="text/css" />
...
<body class="kt-page--loading-enabled kt-page--loading kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header--minimize-menu kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--left kt-aside--fixed kt-page--loading">
    ...
    <div class="kt-grid kt-grid--ver kt-grid--root kt-page">
        <div class="kt-grid__item kt-grid__item--fluid kt-grid  kt-error-v5" style="background-image: url(<?= base_url(); ?>/vendor/assets/media/error/bg5.jpg);">
            ...
            <h1>403</h1>       
                ...
                <p class="kt-error_description">
                    ...
                    <br> as soon possible.
                    <br> You can back or use our Help Center.
                </p>
            </div>
        </div>
    </div>
